...
│  │  Accessible paths:                                             │   │
│  │    • groups/{name}/ (group folder)                             │   │
│  │    • groups/global/ (non-main only, read-only)                 │   │
│  │    • Additional mounts (as configured)                         │   │
│  │                                                                │   │
│  │  Tools (all groups):                                           │   │
│  │    • Bash (runs on host in group context)                      │   │
...
| Browser Automation | Playwright + Chromium | Web interaction and screenshots |
| Runtime | Node.js 20+ / Bun | Host process for routing and scheduling |
| Service Manager | systemd / launchd | Background service management |
